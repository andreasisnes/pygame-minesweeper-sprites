...
class TestTileBuilder(unittest.TestCase):
    ...
    def test_Init_WrongTypeOfArgument_RaiseTypeError(self):
        self.assertRaises(TypeError, sprites.TileBuilder, sprites.TileSheets.two)
    
    def test_Init_MonochromeSheet_ValidateExcludedInternalSheetDictKeys(self):
        builder = sprites.TileBuilder(sprites.TileSheets(sprites.TileSheets.monochrome))
    ...
    def validate_key(self, key):
        builder = sprites.TileBuilder(sprites.TileSheets(sprites.TileSheets.ninety_five))
...
class TestTile(unittest.TestCase):
    ...
    def test_GetItem_IndexWith9_RaiseValueError(self):
        self.assertRaises(ValueError, sprites.TileBuilder().build().__getitem__, 9)
        self.assertRaises(ValueError, sprites.TileBuilder().build().__getitem__, "9")
