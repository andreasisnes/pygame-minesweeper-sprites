...
class ScoreBuilder(SpritesheetBuilder):
    ...
    def zero(self, sheet : ScoreSheets) -> 'TileBuilder':
        self.__setter__(sheet, self.zero.__name__, 0)
        return self
    def one(self, sheet : ScoreSheets) -> 'TileBuilder':
        self.__setter__(sheet, self.one.__name__, 1)
        return self
    def two(self, sheet : ScoreSheets) -> 'TileBuilder':
        self.__setter__(sheet, self.two.__name__, 2)
        return self
    def three(self, sheet : ScoreSheets) -> 'TileBuilder':
        self.__setter__(sheet, self.three.__name__, 3)
        return self
    def four(self, sheet : ScoreSheets) -> 'TileBuilder':
        self.__setter__(sheet, self.four.__name__, 4)
        return self
    def five(self, sheet : ScoreSheets) -> 'TileBuilder':
        self.__setter__(sheet, self.five.__name__, 5)
        return self
    def six(self, sheet : ScoreSheets) -> 'TileBuilder':
        self.__setter__(sheet, self.six.__name__, 6)
        return self
    def seven(self, sheet : ScoreSheets) -> 'TileBuilder':
        self.__setter__(sheet, self.seven.__name__, 7)
        return self
    def eight(self, sheet : ScoreSheets) -> 'TileBuilder':
